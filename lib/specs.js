...
exports['android-default-notlong-land-xxxhdpi'] = {
  ...
  ninePath: path.join('platform', 'android', 'res', 'drawable-land-xxxhdpi', 'splash.9.png'),
  nineLocalePath: path.join('platform', 'android', 'res', 'drawable-:locale:-land-xxxhdpi', 'splash.9.png'),
  width: 1920,
  height: 1280,
  dpi: constants.dpi.xxhdpi,
  platforms: ['android'],
...
exports['android-default-notlong-land-xxhdpi'] = {
  ...
  ninePath: path.join('platform', 'android', 'res', 'drawable-land-xxhdpi', 'splash.9.png'),
  nineLocalePath: path.join('platform', 'android', 'res', 'drawable-:locale:-land-xxhdpi', 'splash.9.png'),
  width: 1600,
  height: 960,
  dpi: constants.dpi.xxhdpi,
  platforms: ['android'],
...
exports['android-default-notlong-land-xhdpi'] = {
  ...
  ninePath: path.join('platform', 'android', 'res', 'drawable-land-xhdpi', 'splash.9.png'),
  nineLocalePath: path.join('platform', 'android', 'res', 'drawable-:locale:-land-xhdpi', 'splash.9.png'),
  width: 960,
  height: 640,
  dpi: constants.dpi.xhdpi,
  platforms: ['android'],
...
exports['android-default-notlong-land-hdpi'] = {
  ...
  ninePath: path.join('platform', 'android', 'res', 'drawable-land-hdpi', 'splash.9.png'),
  nineLocalePath: path.join('platform', 'android', 'res', 'drawable-:locale:-land-hdpi', 'splash.9.png'),
  width: 800,
  widthFix: 640,
  height: 480,
  dpi: constants.dpi.hdpi,
...
exports['android-default-notlong-land-mdpi'] = {
  ...
  ninePath: path.join('platform', 'android', 'res', 'drawable-land-mdpi', 'splash.9.png'),
  nineLocalePath: path.join('platform', 'android', 'res', 'drawable-:locale:-land-mdpi', 'splash.9.png'),
  width: 480,
  height: 320,
  dpi: constants.dpi.mdpi,
  platforms: ['android'],
...
exports['android-default-notlong-land-ldpi'] = {
  ...
  ninePath: path.join('platform', 'android', 'res', 'drawable-land-ldpi', 'splash.9.png'),
  nineLocalePath: path.join('platform', 'android', 'res', 'drawable-:locale:-land-ldpi', 'splash.9.png'),
  width: 320,
  height: 240,
  dpi: constants.dpi.ldpi,
  platforms: ['android'],
...
exports['android-default-notlong-port-xxxhdpi'] = {
  ...
  ninePath: path.join('platform', 'android', 'res', 'drawable-port-xxxhdpi', 'splash.9.png'),
  nineLocalePath: path.join('platform', 'android', 'res', 'drawable-:locale:-port-xxxhdpi', 'splash.9.png'),
  width: 1280,
  height: 1920,
  dpi: constants.dpi.xxxhdpi,
  platforms: ['android'],
...
exports['android-default-notlong-port-xxhdpi'] = {
  ...
  ninePath: path.join('platform', 'android', 'res', 'drawable-port-xxhdpi', 'splash.9.png'),
  nineLocalePath: path.join('platform', 'android', 'res', 'drawable-:locale:-port-xxhdpi', 'splash.9.png'),
  width: 960,
  height: 1600,
  dpi: constants.dpi.xxhdpi,
  platforms: ['android'],
...
exports['android-default-notlong-port-xhdpi'] = {
  ...
  ninePath: path.join('platform', 'android', 'res', 'drawable-port-xhdpi', 'splash.9.png'),
  nineLocalePath: path.join('platform', 'android', 'res', 'drawable-:locale:-port-xhdpi', 'splash.9.png'),
  width: 640,
  height: 960,
  dpi: constants.dpi.xhdpi,
  platforms: ['android'],
...
exports['android-default-notlong-port-hdpi'] = {
  ...
  ninePath: path.join('platform', 'android', 'res', 'drawable-port-hdpi', 'splash.9.png'),
  nineLocalePath: path.join('platform', 'android', 'res', 'drawable-:locale:-port-hdpi', 'splash.9.png'),
  width: 480,
  height: 800,
  heightFix: 640,
  dpi: constants.dpi.hdpi,
...
exports['android-default-notlong-port-mdpi'] = {
  ...
  ninePath: path.join('platform', 'android', 'res', 'drawable-port-mdpi', 'splash.9.png'),
  nineLocalePath: path.join('platform', 'android', 'res', 'drawable-:locale:-port-mdpi', 'splash.9.png'),
  width: 320,
  height: 480,
  dpi: constants.dpi.mdpi,
  platforms: ['android'],
...
exports['android-default-notlong-port-ldpi'] = {
  ...
  ninePath: path.join('platform', 'android', 'res', 'drawable-port-ldpi', 'splash.9.png'),
  nineLocalePath: path.join('platform', 'android', 'res', 'drawable-:locale:-port-ldpi', 'splash.9.png'),
  width: 240,
  height: 320,
  dpi: constants.dpi.ldpi,
  platforms: ['android'],
