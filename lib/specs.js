...
exports['ios-Default-Portrait-1792h@3x'] = {
  type: 'splash',
  path: path.join(':assets:', 'iphone', 'Default-Portrait-1792h@3x.png'),
  localePath: path.join(':i18n:', ':locale:', 'Default-Portrait-1792h@3x.png'),
  width: 828,
  height: 1792,
  platforms: ['iphone'],
  sdkVersion: '>=7.4.0'
};
exports['ios-Default-Landscape-1792h@3x'] = {
  type: 'splash',
  path: path.join(':assets:', 'iphone', 'Default-Landscape-1792h@3x.png'),
  localePath: path.join(':i18n:', ':locale:', 'Default-Landscape-1792h@3x.png'),
  width: 1792,
  height: 828,
  platforms: ['iphone'],
  sdkVersion: '>=7.4.0'
