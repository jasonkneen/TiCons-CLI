    ...
    it('generates expected files', function(done) {
      ...
      ticons.splashes({
        ...
        _.sortBy(output, _.identity).should.be.eql(_.sortBy({
          ...
          "android-default-notlong-land-ldpi": path.join(tmpDir,"/platform/android/res/drawable-land-ldpi/splash.9.png"),
          "mobileweb-Default-jpg": path.join(tmpDir,"/app/assets/mobileweb/apple_startup_images/Default.jpg"),
          "android-default-notlong-land-mdpi": path.join(tmpDir,"/platform/android/res/drawable-land-mdpi/splash.9.png"),
          "android-default-notlong-port-ldpi": path.join(tmpDir,"/platform/android/res/drawable-port-ldpi/splash.9.png"),
          ...
          "android-default-notlong-land-hdpi": path.join(tmpDir,"/platform/android/res/drawable-land-hdpi/splash.9.png"),
          "android-default-notlong-port-mdpi": path.join(tmpDir,"/platform/android/res/drawable-port-mdpi/splash.9.png"),
          "mobileweb-Default-png": path.join(tmpDir,"/app/assets/mobileweb/apple_startup_images/Default.png"),
          "android-default-notlong-land-xhdpi": path.join(tmpDir,"/platform/android/res/drawable-land-xhdpi/splash.9.png"),
          "android-default-notlong-land-xxhdpi": path.join(tmpDir,"/platform/android/res/drawable-land-xxhdpi/splash.9.png"),
          "android-default-notlong-land-xxxhdpi": path.join(tmpDir,"/platform/android/res/drawable-land-xxxhdpi/splash.9.png"),
          "android-default-notlong-port-hdpi": path.join(tmpDir,"/platform/android/res/drawable-port-hdpi/splash.9.png"),
          "android-default-notlong-port-xhdpi": path.join(tmpDir,"/platform/android/res/drawable-port-xhdpi/splash.9.png"),
          "android-default-notlong-port-xxhdpi": path.join(tmpDir,"/platform/android/res/drawable-port-xxhdpi/splash.9.png"),
          "android-default-notlong-port-xxxhdpi": path.join(tmpDir,"/platform/android/res/drawable-port-xxxhdpi/splash.9.png"),
