    ...
    it('generates expected files', function(done) {
      ...
      ticons.splashes({
        ...
        _.sortBy(output, _.identity).should.be.eql(_.sortBy({
          ...
          "android-default-notlong-land-ldpi": tmpDir + "/platform/android/res/drawable-land-ldpi/splash.9.png",
          "mobileweb-Default-jpg": tmpDir + "/app/assets/mobileweb/apple_startup_images/Default.jpg",
          "android-default-notlong-land-mdpi": tmpDir + "/platform/android/res/drawable-land-mdpi/splash.9.png",
          "android-default-notlong-port-ldpi": tmpDir + "/platform/android/res/drawable-port-ldpi/splash.9.png",
          ...
          "android-default-notlong-land-hdpi": tmpDir + "/platform/android/res/drawable-land-hdpi/splash.9.png",
          "android-default-notlong-port-mdpi": tmpDir + "/platform/android/res/drawable-port-mdpi/splash.9.png",
          "mobileweb-Default-png": tmpDir + "/app/assets/mobileweb/apple_startup_images/Default.png",
          "android-default-notlong-land-xhdpi": tmpDir + "/platform/android/res/drawable-land-xhdpi/splash.9.png",
          "android-default-notlong-land-xxhdpi": tmpDir + "/platform/android/res/drawable-land-xxhdpi/splash.9.png",
          "android-default-notlong-port-hdpi": tmpDir + "/platform/android/res/drawable-port-hdpi/splash.9.png",
