...
// foregrounds
exports['android-appicon-foreground-ldpi'] = {
  type: 'icon-foreground',
  path: path.join(':platform:', 'android', 'res', 'mipmap-ldpi', 'appicon_foreground.png'),
  size: 81,
  alpha: true,
  dpi: constants.dpi.ldpi,
  platforms: ['android']
};
exports['android-appicon-foreground-mdpi'] = {
  type: 'icon-foreground',
  path: path.join(':platform:', 'android', 'res', 'mipmap-mdpi', 'appicon_foreground.png'),
  size: 108,
  alpha: true,
  dpi: constants.dpi.mdpi,
  platforms: ['android']
};
exports['android-appicon-foreground-hdpi'] = {
  type: 'icon-foreground',
  path: path.join(':platform:', 'android', 'res', 'mipmap-hdpi', 'appicon_foreground.png'),
  size: 162,
  alpha: true,
  dpi: constants.dpi.hdpi,
  platforms: ['android']
};
exports['android-appicon-foreground-xhdpi'] = {
  type: 'icon-foreground',
  path: path.join(':platform:', 'android', 'res', 'mipmap-xhdpi', 'appicon_foreground.png'),
  size: 216,
  alpha: true,
  dpi: constants.dpi.xhdpi,
  platforms: ['android']
};
exports['android-appicon-foreground-xxhdpi'] = {
  type: 'icon-foreground',
  path: path.join(':platform:', 'android', 'res', 'mipmap-xxhdpi', 'appicon_foreground.png'),
  size: 324,
  alpha: true,
  dpi: constants.dpi.xxhdpi,
  platforms: ['android']
};
exports['android-appicon-foreground-xxxhdpi'] = {
  type: 'icon-foreground',
  path: path.join(':platform:', 'android', 'res', 'mipmap-xxxhdpi', 'appicon_foreground.png'),
  size: 432,
  alpha: true,
  dpi: constants.dpi.xxxhdpi,
  platforms: ['android']
