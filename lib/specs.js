...
// Apple Watch
exports['apple-watch-40x40@2x'] = {
	type: 'icon',
	path: path.join('apple-watch', '40x40@2x.png'),
	size: 80,
	platforms: ['apple-watch']
};
exports['apple-watch-44x44@2x'] = {
	type: 'icon',
	path: path.join('apple-watch', '44x44@2x.png'),
	size: 88,
	platforms: ['apple-watch']
};
exports['apple-watch-86x86@2x'] = {
	type: 'icon',
	path: path.join('apple-watch', '86x86@2x.png'),
	size: 172,
	platforms: ['apple-watch']
};
exports['apple-watch-29x29@2x'] = {
	type: 'icon',
	path: path.join('apple-watch', '29x29@2x.png'),
	size: 58,
	platforms: ['apple-watch']
};
exports['apple-watch-24x24@2x'] = {
	type: 'icon',
	path: path.join('apple-watch', '24x24@2x.png'),
	size: 48,
	platforms: ['apple-watch']
};
exports['apple-watch-98x98@2x'] = {
	type: 'icon',
	path: path.join('apple-watch', '98x98@2x.png'),
	size: 196,
	platforms: ['apple-watch']
};
exports['apple-watch-29x29@3x'] = {
	type: 'icon',
	path: path.join('apple-watch', '29x29@3x.png'),
	size: 87,
	platforms: ['apple-watch']
};
exports['apple-watch-27.5x27.5@2x'] = {
	type: 'icon',
	path: path.join('apple-watch', '27.5x27.5@2x.png'),
	size: 55,
	platforms: ['apple-watch']
};
...
exports['windows-Square44x44Logo.scale-100'] = {
	type: 'icon',
	path: path.join(':assets:', 'windows', 'Square44x44Logo.scale-100.png'),
	size: 44,
	alpha: true,
	platforms: ['windows']
};
